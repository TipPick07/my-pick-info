...
const OG_TITLE = "자녀 적금·청약·보험 — 아이 이름의 돈 3축 설계 (2026)";
const OG_DESC =
    "자녀 적금·증여(10년 2천만원 비과세)로 모으고, 청약통장(만 14세부터 5년 인정)으로 앞당기고, 보험은 보장형으로 지키는 3축 설계 — 2026년 기준.";

export const metadata: Metadata = {
    title: "자녀 적금·청약·보험 — 아이 이름의 돈 3축 설계 (2026) | 팁픽",
    description:
        "자녀 적금·증여(10년 2천만원 비과세)로 모으고, 청약통장(만 14세부터 5년 인정)으로 앞당기고, 보험은 보장형으로 지키는 3축 설계 — 2026년 기준.",
            ...
            <main className="bg-white text-slate-800">
                ...
                <div className="mx-auto max-w-3xl space-y-16 px-5 py-14">
                    ...
                    <section className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                        ...
                        >
                            <span className="text-sm font-bold">청약홈에서 청약통장 만들기 →</span>
                            <span className="mt-1 text-xs text-indigo-100">
                                applyhome.co.kr · 자녀 청약통장 가입
                            </span>
                        </a>
                        <Link
                            href="/benefits/"
