      ...
      <header className="sticky top-0 z-50 w-full bg-white/70 backdrop-blur-md border-b border-slate-200/50 transition-all duration-300">
        <div className="container mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8 text-sm font-semibold text-slate-600">
            <a href="#" className="hover:text-indigo-600 transition-colors">로컬 소식</a>
            <a href="#" className="hover:text-indigo-600 transition-colors">축제/행사</a>
            <a href="#" className="hover:text-indigo-600 transition-colors">지원금 혜택</a>
            <a href="#" className="hover:text-indigo-600 transition-colors">매거진</a>
          </nav>
          <button className="bg-slate-900 text-white px-5 py-2.5 rounded-full text-sm font-bold hover:bg-slate-800 transition-all active:scale-95 shadow-lg shadow-slate-200">
            내 지역 설정
          </button>
        </div>
      </header>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <section className="lg:col-span-2 space-y-8">
            <div className="flex items-center justify-between px-2">
              ...
              <a href="#" className="text-sm font-bold text-indigo-600 hover:underline">전체 보기 →</a>
            </div>
        ...
        <section className="space-y-8 pt-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {data.blogPosts.map((p) => (
              <Link key={p.id} href={`/blog/${p.id}`} className="hover:-translate-y-2 transition-all duration-500 group cursor-pointer bg-white rounded-[2.5rem] overflow-hidden border border-slate-100 shadow-sm hover:shadow-2xl">
                ...
                <div className="p-8 space-y-4">
                  <span className="text-xs font-black text-indigo-600 tracking-widest uppercase">{p.category}</span>
                  <h4 className="text-xl font-black leading-snug text-slate-900 group-hover:text-indigo-600 transition-colors">
                    {p.title}
                  </h4>
                  ...
                  <div className="pt-2 flex items-center justify-between">
                    <span className="text-slate-400 text-xs font-bold">2026.04.05</span>
                    <span className="text-indigo-600 text-sm font-black group-hover:translate-x-1 transition-transform inline-block">더 읽어보기 →</span>
                  </div>
                </div>
              </Link>
            ))}
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            ...
            <div className="space-y-4">
              ...
              <ul className="text-sm space-y-2 font-medium">
                <li><a href="#" className="hover:text-white transition-colors">로컬 소식</a></li>
                <li><a href="#" className="hover:text-white transition-colors">축제/행사</a></li>
                <li><a href="#" className="hover:text-white transition-colors">지원금/혜택</a></li>
              </ul>
            </div>
            <div className="space-y-4">
              <h5 className="text-white font-bold text-sm">고객센터</h5>
              <ul className="text-sm space-y-2 font-medium">
                <li><a href="#" className="hover:text-white transition-colors">문의하기</a></li>
                <li><a href="#" className="hover:text-white transition-colors">제휴 제안</a></li>
