...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const basePaths = [
    ...
    '/tools/retirement-pay/', '/tools/hourly-wage/', '/tools/car-tax/', '/tools/savings-interest/', '/tools/rent-conversion/', '/tools/brokerage-fee/', '/tools/annual-leave-allowance/', '/tools/overseas-stock-tax/', '/tools/median-income/', '/tools/parental-leave-pay/', '/tools/electricity-bill/', '/tools/unemployment-benefit/',
  ];
