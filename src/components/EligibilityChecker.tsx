...
// ── 진입점 ───────────────────────────────────────────────────────────────────
// 2026-08-09: 매처 모드(BenefitMatcher) 삭제. 결과 CTA가 크롤 시대의 혜택 상세 라우트를
//   가리켰는데 그 라우트를 제거했고, benefitPool을 넘기는 호출자도 없어 도달 불가한 코드였다
//   (유일한 사용처였던 /eligibility 라우트는 2026-07 통폐합 때 이미 301 처리됨).
