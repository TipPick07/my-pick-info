...
export const GUIDES: Guide[] = [
  {
    ...
    title: "국가장학금 신청 4단계, 가구원 동의·서류 확인",
    description:
  ...
  },
  {
    ...
    title: "숨은 돈 찾기 창구 6곳, 시효 지나기 전 조회 순서",
    description:
  ...
  },
  {
    ...
    title: "예금자보호 한도 1억 원, 이자까지 넣은 안전선 계산",
    description:
  ...
  },
  {
    ...
    title: "유보통합포털 자녀등록, 어린이집·유치원 입소 순위 확인",
    description:
      "자녀등록을 마쳐야 신청이 열린다. 어린이집은 1순위 100점 점수제 대기순번, 유치원은 순위 없이 희망순 무작위 추첨 — 두 제도의 차이를 한 표로 정리한 가이드.",
    category: "임신·출산·육아",
    emoji: "🧸",
  ...
  },
  {
    ...
    title: "청년 지원금 월세 480만 원, 목돈·주거·취업 신청 순서",
    description:
