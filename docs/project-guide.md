...
- 2026-06-04 | [UI/콘텐츠] 지원금 상세 '지원 내용' 가독성 개선 — 행간 확대+본문 굵기 완화(SummaryCard 공유, 축제·블로그 동시 적용), 원본 불릿(○) 렌더 시점 정제, Gemini 프롬프트를 소제목(■)+짧은문단 400~600자 구조로 변경(일반·주거·보완 3곳) | 미커밋 | SummaryCard.tsx, benefit/[id]/page.tsx, fetch-public-data.js
